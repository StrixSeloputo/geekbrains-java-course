...
public class JDBC implements AutoCloseable {
    ...
    public long insertRowEx(PreparedStatement preparedInsertStatement) throws SQLException {
        ...
        try (ResultSet generatedKeys = preparedInsertStatement.getGeneratedKeys()) {
